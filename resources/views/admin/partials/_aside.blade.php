				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="index.html" class="brand-logo">
							<img alt="Logo" src="assets/media/logos/logofav.png" />
						</a>
                                        ...
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-datatable.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">Paid Vendors</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-columns-1.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">Free Vendors</span>
                                                </a>
                                            </li>
...
{{--                                client list start here --}}
                                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="javascript:;" class="menu-link menu-toggle">
                                        ...
                                        <span class="menu-text">Clinets</span>
{{--                                        <span class="menu-label">--}}
{{--														<span class="label label-rounded label-primary">6</span>--}}
{{--													</span>--}}
                                        <i class="menu-arrow"></i>
                                        ...
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-datatable.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">Recent Clients</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-columns-1.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">New Clients</span>
                                                </a>
                                            </li>
...
{{--                                     product list code--}}
                                ...
                                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="javascript:;" class="menu-link menu-toggle">
                                        ...
                                        <span class="menu-text">Products Section</span>
{{--                                        <span class="menu-label">--}}
{{--														<span class="label label-rounded label-primary">6</span>--}}
{{--													</span>--}}
                                        <i class="menu-arrow"></i>
                                        ...
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-columns-1.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">Sold Today</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" aria-haspopup="true">
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/add-user.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">Reported Product</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" aria-haspopup="true">
                                        ...
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-columns-1.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">Reported Services</span>
                                                </a>
                                            </li>
...
{{--                                videos list--}}
                                ...
                                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="javascript:;" class="menu-link menu-toggle">
                                        ...
                                        <span class="menu-text">Video Section</span>
{{--                                        <span class="menu-label">--}}
{{--														<span class="label label-rounded label-primary">6</span>--}}
{{--													</span>--}}
                                        <i class="menu-arrow"></i>
                                        ...
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-datatable.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">Most Liked</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-columns-1.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">Most Viewed</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-columns-2.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">Reported Videos</span>
                                                </a>
                                            </li>
...
{{--                                tickets list--}}
                                ...
                                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="javascript:;" class="menu-link menu-toggle">
                                        ...
                                        <span class="menu-text">Ticket Section</span>
{{--                                        <span class="menu-label">--}}
{{--														<span class="label label-rounded label-primary">6</span>--}}
{{--													</span>--}}
                                        <i class="menu-arrow"></i>
                                        ...
                                        <ul class="menu-subnav">
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-default.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">All Vouchers</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-datatable.html" class="menu-link">
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-columns-1.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">Most Sold</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-columns-2.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">Reported Tickets</span>
                                                </a>
                                            </li>
...
{{--                                jobs list --}}
                                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="javascript:;" class="menu-link menu-toggle">
                                        ...
                                        <span class="menu-text">Job Section</span>
{{--                                        <span class="menu-label">--}}
{{--														<span class="label label-rounded label-primary">6</span>--}}
{{--													</span>--}}
                                        <i class="menu-arrow"></i>
                                        ...
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-columns-1.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">Reported</span>
                                                </a>
                                            </li>
...
{{--                                foods list--}}
                                ...
                                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="javascript:;" class="menu-link menu-toggle">
                                        ...
                                        <span class="menu-text">Food Section</span>
{{--                                        <span class="menu-label">--}}
{{--														<span class="label label-rounded label-primary">6</span>--}}
{{--													</span>--}}
                                        <i class="menu-arrow"></i>
                                        ...
                                        <ul class="menu-subnav">
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-default.html" class="menu-link">
                                                    ...
                                                    <span class="menu-text">All Items</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" aria-haspopup="true">
                                                <a href="custom/apps/user/list-datatable.html" class="menu-link">
...
{{--                                vendor verification--}}
                                ...
                                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="javascript:;" class="menu-link menu-toggle">
                                        ...
                                        <span class="menu-text">Vendor Verification</span>
{{--                                        <span class="menu-label">--}}
{{--														<span class="label label-rounded label-primary">6</span>--}}
{{--													</span>--}}
                                        <i class="menu-arrow"></i>
...
{{--                                vendor verification list end here--}}


{{--                                product disscussions--}}

                                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="javascript:;" class="menu-link menu-toggle">

                                        <span class="menu-text">Product Discussion</span>
{{--                                        <span class="menu-label">--}}
{{--														<span class="label label-rounded label-primary">6</span>--}}
{{--													</span>--}}
                                        <i class="menu-arrow"></i>
...
{{--                                payemnt section end here  /--}}



{{--                            new list item code end here--}}
